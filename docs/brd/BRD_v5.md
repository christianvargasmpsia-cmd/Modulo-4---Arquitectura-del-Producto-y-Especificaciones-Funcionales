...
| Cobertura automatizada de pruebas | >85% |
| Reducción de pruebas manuales | >80% |
---
...
* Análisis inteligente de resultados de pruebas.
...
| BO-05 | Automatizar pruebas funcionales | >80% de pruebas automatizadas |
| BO-06 | Reducir tiempo de validación de versiones | <10 minutos por release |
---
...
| BC-09 | Automatización de pruebas | Automatizar generación, ejecución y análisis inteligente de pruebas funcionales y de APIs para asegurar la calidad del sistema durante todo el ciclo de vida. |
...
| BR-009 | Automatización de pruebas API        | Must      | El sistema deberá automatizar la ejecución de pruebas funcionales sobre las APIs del Marketplace.                             |
| BR-010 | Generación automática de pruebas E2E | Should    | El sistema deberá generar automáticamente casos de prueba End-to-End a partir de las especificaciones funcionales. |
| BR-011 | Análisis inteligente de resultados   | Should    | El sistema deberá analizar automáticamente los resultados de ejecución utilizando IA para clasificar errores y generar recomendaciones. |
...
| Resultados incorrectos generados por IA | Medio | Validación humana antes del despliegue |
| Cambios en APIs externas | Alto | Versionado y ejecución continua de pruebas |
---
...
| BRD | PRD | FSD | Artefacto Implementado |
|-----|-----|-----|----------------|
| BR-001 | PRD-AUTH-01 | FSD-AUTH | Pendiente |
| BR-002 | PRD-PAY-01 | FSD-PAY | Pendiente |
| BR-003 | PRD-STOCK-01 | FSD-INVENTORY | Pendiente |
| BR-004 | PRD-ORDER-01 | FSD-ORDERS | Pendiente |
| BR-009 | PRD-QA-01 | FSD-MCP | src/agents/postman.agent.js |
| BR-010 | PRD-QA-02 | FSD-PLAYWRIGHT | src/agents/AITestingAgent.js |
| BR-011 | PRD-QA-03 | FSD-AI | src/analyzers/ |
...
---
# 23. Estrategia de Aseguramiento de Calidad Basada en IA

Con el objetivo de garantizar la calidad funcional del Marketplace UMSS Market durante todo su ciclo de vida, la solución incorpora una plataforma de automatización de pruebas basada en Inteligencia Artificial.

Esta plataforma permite automatizar la validación continua de funcionalidades críticas mediante tres componentes especializados:

- MCP Postman Agent para descubrimiento y ejecución automática de colecciones Postman.
- AI Playwright Testing Agent para generación automática de pruebas End-to-End.
- AI Test Analyzer para análisis inteligente de resultados, clasificación de errores y generación de recomendaciones técnicas.

Esta estrategia reduce el esfuerzo manual de validación, mejora la trazabilidad de calidad y proporciona retroalimentación continua durante el proceso AI-SDLC. 
...
AI Testing Platform
 ...
 ┌───┼───────────────┐
 ▼   ▼               ▼
MCP Agent     Playwright Agent     AI Analyzer
     │               │               │
     └───────────────┼───────────────┘
                     ▼
...
| v5.0 | 06/07/2026 | Rodriguez Gonzales Abad Melani / Vargas Sandoval Christian Bernardo | Incorporación de la estrategia AI Testing Platform, capacidades de automatización de pruebas, nuevos requerimientos de negocio, trazabilidad completa BRD → PRD → FSD → Features y alineación con AI-SDLC. |